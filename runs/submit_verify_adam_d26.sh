#!/bin/bash
#SBATCH --job-name=v_adam_d26
#SBATCH --account=lingo
#SBATCH --partition=lingo-h100
#SBATCH --qos=lingo-main
#SBATCH --time=12:00:00
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/verify_adam_d26_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/verify_adam_d26_%j.err
#SBATCH --gpus=2
...
export TORCHINDUCTOR_CACHE_DIR="/tmp/torchinductor_v_adam_d26_$$"
