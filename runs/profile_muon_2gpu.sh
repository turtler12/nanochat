#!/bin/bash
#SBATCH --job-name=prof_muon2
#SBATCH --account=lingo
#SBATCH --partition=lingo-h100
#SBATCH --qos=lingo-main
#SBATCH --time=00:30:00
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/profile_muon_2gpu_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/profile_muon_2gpu_%j.err
#SBATCH --gpus=2
...
export TORCHINDUCTOR_CACHE_DIR="/tmp/torchinductor_prof_muon2_$$"
