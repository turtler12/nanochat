...
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/eta_neg0.1_lr0.02_d12_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/eta_neg0.1_lr0.02_d12_%j.err
#SBATCH --gpus=2
...
export TORCHINDUCTOR_CACHE_DIR="/tmp/torchinductor_eta_neg0.1_$$"
...
torchrun --standalone --nproc_per_node=2 --master_port=$((29500 + RANDOM % 1000)) \
    ...
    --model-tag eta_sweep_neg0.1_lr0.02_d12 \
    --run dummy
