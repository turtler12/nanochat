#!/bin/bash
#SBATCH --job-name=eta-0.3
#SBATCH --account=lingo
#SBATCH --partition=lingo-h100
#SBATCH --qos=lingo-main
#SBATCH --time=02:00:00
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/eta_neg0.3_lr0.02_d12_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/eta_neg0.3_lr0.02_d12_%j.err
#SBATCH --gpus=2
...
export TORCHINDUCTOR_CACHE_DIR="/tmp/torchinductor_eta_neg0.3_$$"
...
torchrun --standalone --nproc_per_node=2 --master_port=$((29500 + RANDOM % 1000)) \
    ...
    --model-tag eta_sweep_neg0.3_lr0.02_d12 \
    --run dummy
