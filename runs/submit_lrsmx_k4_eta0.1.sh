#!/bin/bash
#
#SBATCH --job-name=lrsmx_k4
#SBATCH --account=lingo
#SBATCH --partition=lingo-h100
#SBATCH --qos=lingo-main
#SBATCH --time=08:00:00
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/lrsmx_k4_eta0.1_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/lrsmx_k4_eta0.1_%j.err
#SBATCH --gpus=2
...
echo "Config: HybridSoftmaxMuon k=4 eta=0.1"
...
torchrun --standalone --nproc_per_node=2 --master_port=$((29500 + RANDOM % 1000)) \
    ...
    --model-tag lrsmx_k4_eta0.1_d20 \
    --run dummy

echo "========================================"
echo "HybridSoftmaxMuon k=4 eta=0.1 completed at: $(date)"
echo "========================================"
