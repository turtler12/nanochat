#!/bin/bash
#
#SBATCH --job-name=csvd_f20
#SBATCH --account=lingo
#SBATCH --partition=lingo-h100
#SBATCH --qos=lingo-main
#SBATCH --time=01:50:00
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/csvd_freq20_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/csvd_freq20_%j.err
#SBATCH --gpus=2
...
echo "Config: Cached-SVD SoftmaxMuon svd_freq=20"
...
export TORCHINDUCTOR_CACHE_DIR="/tmp/torchinductor_csvd_f20_$$"
...
for attempt in 1 2 3; do
    ...
    torchrun --standalone --nproc_per_node=2 --master_port=$((29500 + RANDOM % 1000)) \
        ...
        --model-tag cached_svd_freq20_d20 \
        --run dummy
    exit_code=$?
...
echo "========================================"
echo "svd_freq=20 completed at: $(date)"
echo "========================================"
