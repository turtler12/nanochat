#!/bin/bash
#
#SBATCH --job-name=csvd_base
#SBATCH --account=lingo
#SBATCH --partition=lingo-h100
#SBATCH --qos=lingo-main
#SBATCH --time=01:50:00
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/csvd_baseline_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/csvd_baseline_%j.err
#SBATCH --gpus=2
...
echo "Config: Baseline Muon (cached-SVD comparison)"
...
export TORCHINDUCTOR_CACHE_DIR="/tmp/torchinductor_csvd_baseline_$$"
...
for attempt in 1 2 3; do
    ...
    torchrun --standalone --nproc_per_node=2 --master_port=$((29500 + RANDOM % 1000)) \
        ...
        --fp8 \
        --model-tag cached_svd_baseline_d20 \
        --run dummy
    exit_code=$?
