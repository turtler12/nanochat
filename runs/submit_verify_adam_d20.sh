#!/bin/bash
#SBATCH --job-name=v_adam_d20
#SBATCH --account=lingo
#SBATCH --partition=lingo-h100
#SBATCH --qos=lingo-main
#SBATCH --time=08:00:00
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/verify_adam_d20_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/verify_adam_d20_%j.err
#SBATCH --gpus=2
...
export TORCHINDUCTOR_CACHE_DIR="/tmp/torchinductor_v_adam_d20_$$"
