#!/bin/bash
#SBATCH --job-name=prof_tay4
#SBATCH --account=lingo
#SBATCH --partition=lingo-h100
#SBATCH --qos=lingo-main
#SBATCH --time=00:30:00
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/profile_taylor_4gpu_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/profile_taylor_4gpu_%j.err
#SBATCH --gpus=4
...
export TORCHINDUCTOR_CACHE_DIR="/tmp/torchinductor_prof_tay4_$$"
