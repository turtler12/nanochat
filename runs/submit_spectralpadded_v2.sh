#!/bin/bash
#
#SBATCH --job-name=spectralpad_v2
#SBATCH --account=lingo
#SBATCH --partition=lingo-h100
#SBATCH --qos=lingo-main
#SBATCH --time=06:30:00
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/spectralpad_v2_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/spectralpad_v2_%j.err
#SBATCH --gpus=4
#SBATCH --cpus-per-task=32
#SBATCH --mem=256G
#
# Spectral-padded Muon v2 — fixed blend formula.
#   update = (1-γ) * σ_max * P + γ * g_raw
# At γ=0: standard Muon. At γ>0: spectral padding.
#
...
#   SV_LOG_EVERY    - log every N steps (default: 250)
...
export SV_LOG_EVERY="${SV_LOG_EVERY:-250}"
...
mkdir -p spectralpadded_v2_results slurm_logs
...
if [ -f "spectralpadded_v2_results/$TAG/val_loss.json" ]; then
...
torchrun --standalone --nproc_per_node=4 \
    -m scripts.spectralpadded_muon_train_v2 -- \
    --depth 20 \
    ...
    --fp8 \
    --seed 42 \
    --results-dir spectralpadded_v2_results \
    --run dummy
