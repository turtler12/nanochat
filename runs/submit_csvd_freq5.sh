#!/bin/bash
#
#SBATCH --job-name=csvd_f5
#SBATCH --account=lingo
#SBATCH --partition=lingo-h100
#SBATCH --qos=lingo-main
#SBATCH --time=01:50:00
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/csvd_freq5_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/csvd_freq5_%j.err
#SBATCH --gpus=2
...
echo "Config: Cached-SVD SoftmaxMuon svd_freq=5"
...
export TORCHINDUCTOR_CACHE_DIR="/tmp/torchinductor_csvd_f5_$$"
...
for attempt in 1 2 3; do
    ...
    torchrun --standalone --nproc_per_node=2 --master_port=$((29500 + RANDOM % 1000)) \
        ...
        --model-tag cached_svd_freq5_d20 \
        --run dummy
    exit_code=$?
...
echo "========================================"
echo "svd_freq=5 completed at: $(date)"
echo "========================================"
