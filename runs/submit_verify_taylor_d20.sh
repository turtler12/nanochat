#!/bin/bash
#SBATCH --job-name=v_tay_d20
#SBATCH --account=lingo
#SBATCH --partition=lingo-h100
#SBATCH --qos=lingo-main
#SBATCH --time=08:00:00
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/verify_taylor0.5_d20_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/verify_taylor0.5_d20_%j.err
#SBATCH --gpus=2
...
export TORCHINDUCTOR_CACHE_DIR="/tmp/torchinductor_v_tay05_d20_$$"
...
torchrun --standalone --nproc_per_node=2 --master_port=$((29500 + RANDOM % 1000)) \
    ...
    --model-tag verify_taylor0.5_d20 \
    --run dummy
