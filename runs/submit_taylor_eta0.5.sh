#!/bin/bash
#
#SBATCH --job-name=tay_0.5
#SBATCH --account=lingo
#SBATCH --partition=lingo-h100
#SBATCH --qos=lingo-main
#SBATCH --time=08:00:00
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/taylor_eta0.5_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/taylor_eta0.5_%j.err
#SBATCH --gpus=2
...
echo "Config: TaylorMuon eta=0.5"
