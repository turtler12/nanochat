#!/bin/bash
#
#SBATCH --job-name=wsm_0.5
#SBATCH --account=lingo
#SBATCH --partition=lingo-h100
#SBATCH --qos=lingo-main
#SBATCH --time=01:50:00
#SBATCH --output=/data/scratch/medhaven/nanochat/slurm_logs/wsoftmax_eta0.5_%j.log
#SBATCH --error=/data/scratch/medhaven/nanochat/slurm_logs/wsoftmax_eta0.5_%j.err
#SBATCH --gpus=2
...
echo "Config: WeightSoftmaxMuon eta=0.5"
...
echo "========================================"
echo "WeightSoftmaxMuon eta=0.5 completed at: $(date)"
echo "========================================"
