...
Spectral-Padded Muon v2: fixed blend formula.
    ...
    update = (1 - gamma) * sigma_max * P + gamma * g_raw

At gamma=0 this is sigma_max * P, which after variance reduction = standard Muon.
At gamma>0, raw gradient magnitude gets mixed in, lifting tail singular values.

Environment variables:
  PAD_RATIO=0.0           Blend ratio gamma (0.0 = standard Muon, >0 = spectral padding)
...
from scripts.muon_spectralpadded_v2 import (
...
parser.add_argument("--results-dir", type=str, default="spectralpadded_v2_results")
